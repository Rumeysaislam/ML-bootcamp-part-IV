...
# 3. Modeling & Prediction / Model ve tahmin yapma
# 4. Model Evaluation / Model Basarisini olcme
# 5. Hyperparameter Optimization / Knn yonteminin dıssal parametresini (hiperparametresi) optimize etme
...
knn_final.predict(random_user) # Rasgele secilen hastanin diabet olup olmadigini tahmin ettik.
